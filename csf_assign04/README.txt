...
context switch to different processes) was greater than the time saved from creating additional processes. Additional processes are created when the amount of data
is larger than the parition size. The OS kernel can safely assign each core a process without worrying about data collisions. 
