...
These cores exceute in parallel but also require overhead from the OS kernel to create extra processes and context switch when cores fewer than processes.
...
context switch to different processes due to more processes than cores) was greater than the time saved from creating additional processes. 
